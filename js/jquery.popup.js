...
$("i.fa-search-plus", ".lx-projects").on("click",function() {
    ...
    popupImg.attr("src", $(this).parent().parent().find("img").attr("src"));
...
$(".lx-popup-inside a .fa-caret-left", ".lx-popup").on("click",function() {
    ...
    // transmit information to the popup
    popupImg.attr("src", $(".lx-portfolio[data='" + currentpic + "'] img", ".lx-projects").attr("src"));
    popupTitle.text($(".lx-portfolio[data='" + currentpic + "'] h4", ".lx-projects").text());
    pupupCpic.text(currentpic + " of " + nbpics);
    return false;
});
...
$(".lx-popup-inside a .fa-remove", ".lx-popup").on("click",function() {
    // hide popup
